...
class BaseHandler(tornado.web.RequestHandler):
    ...
    def _load_results(self, context):
        ...
        logger.warn('This is the first step')
        ...
        logger.warn('This is the second step')
        if context.request.max_bytes is not None:
            logger.warn('This is the third step')
        ...
        if not context.request.meta:
            logger.warn('This is the 4th step')
        ...
        logger.warn('This is the 5th step')
    ...
    def finish_request(self, context, result_from_storage=None):
        if result_from_storage is not None:
            ...
            logger.warn('This is the final step')
